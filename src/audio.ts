...
const startAudio: ISound = initSound('audio/start.mp3');
const explosionAudio: ISound = initSound('audio/explosion.mp3');
const appearAudio: ISound = initSound('audio/appear.mp3');
const laserAudio: ISound = initSound('audio/laser.mp3');
const laserUfoAudio: ISound = initSound('audio/laser-ufo.mp3');
const blipHi: ISound = initSound('audio/blip-hi.mp3');
const blipLow: ISound = initSound('audio/blip-low.mp3');
const collisionAudio: ISound = initSound('audio/collision.mp3');
